...
export const filterStyles = {
  ...
  earlyShieldLink:      { text: "#FFC800", background: "#000000", border: "#FF4400" },
  earlyShieldBase:      { text: "#FFFFFF", background: "#000000", border: "#FF4400" },
  momentum:             { text: "#FFA500", background: "#320000", border: "#FF0000" },
  twoLink:              { text: "#FFC800", background: "#000000", border: "#FFC800" },
